...
<section class="wrapper">
        ...
        <div class="panel panel-default">
            ...
            <div class="col-sm-3">
                <form action="{{ asset('admin/searchCancelBill') }}">
                <div class="input-group">
                <input type="text" class="input-sm form-control" name="searchCancelBill" placeholder="Search">
                @if ($errors->has('searchCancelBill'))
                    {{ $errors->first('searchCancelBill')  }}
                @endif
            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    @foreach ($searchCancelBill as $bill)
            ...
            <div class="row">
                {{ $searchCancelBill->links('vendor.pagination.custom') }}
            </div>
            </footer>
        </div>
        </div>

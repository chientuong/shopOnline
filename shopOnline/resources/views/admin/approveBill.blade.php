...
<section class="wrapper">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascrpit:" onclick="resetCancelBill({{ $bill->bill_id }})">
                                <button type="submit" class="btn btn-danger">Hủy lại hóa đơn</button>
                            </a>
                            {{-- <a href="{{ asset('admin/resetCancelBill/'.$bill->bill_id) }}" >
                                <button type="submit" class="btn btn-danger">Hủy lại hóa đơn</button>
                            </a> --}}
                        </td>
                    </tr>
    ...
    <script>
        ...
        function resetCancelBill(id) {
            $.ajax({
                type: "GET",
                url: "resetCancelBill/"+id,
                // data: "data",
                // dataType: "dataType",
                success: function (response) {
                    location.reload();
